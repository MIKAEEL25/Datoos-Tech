...
`,
  ...
  {
    title: `Creators (All Disciplines)`,
    features: `Writers, directors, animators, editors, musicians, 3D artists, developers, and any other creative minds interested in building, collaborating, and earning on our Web3 platform.
`,
  },
  {
    title: `No prior Web3 experience required — passion and talent are what matter most.`,
    features: ``,
  },
  {
    title: `How to Apply`,
  ...
  {
    title: `Submit the following`,
    features: `Short intro/reel (30–60 seconds) or portfolio link.
              Headshot or recent photo (for models/actors).
              Brief note on why you’re excited about Web3 entertainment.`,
  },
  {
    title: `We’re reviewing submissions on a rolling basis. Diverse voices strongly encouraged. 
    Join us in shaping the next era of creator-owned media.`,
    features: '',
  },
];
